...
canvas.addEventListener("touchend", () => { isDrawing = false; stopRender("draw"); lastFx = null; lastFy = null; }, { passive: true });
canvas.addEventListener("touchcancel", () => { isDrawing = false; stopRender("draw"); lastFx = null; lastFy = null; }, { passive: true });
/* ==== END painting input ==== */
