console.log("Helena Paint - draw43.js")
...
function clearCanvas(record = true) {
  ...
  try {
    const rect = (canvasWrapper && canvasWrapper.getBoundingClientRect) ? canvasWrapper.getBoundingClientRect() : { width: canvas?.width || 1024, height: canvas?.height || 768 };
    ...
    console.error("clearCanvas error", e);
  }
